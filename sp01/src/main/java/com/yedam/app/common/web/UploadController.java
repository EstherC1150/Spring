...
public class UploadController {
	@Value("${file.upload.path}")	//이 변수값을 불러내서 필드에 복사...
	private String uploadPath;	//불러온 대상 필드에 집어넣는다.
	...
	public List<String> uploadFile(@RequestPart MultipartFile[] uploadFiles) {
	    ...
	    for(MultipartFile uploadFile : uploadFiles){
	        ...
	        try{
	        	uploadFile.transferTo(savePath);	//물리적으로 파일이 복사됨
	...
	private String makeFolder() {	//다시한번 돌려주는...
